    ...
    public class JSONTokenizer extends Object
    {
        ...
        public function getNextToken() : JSONToken
        {
            ...
            switch(this.ch)
            {
                case "{":
                {
                    _loc_1 = JSONToken.create(JSONTokenType.LEFT_BRACE, this.ch);
                    this.nextChar();
                    break;
                }
                case "}":
                {
                    _loc_1 = JSONToken.create(JSONTokenType.RIGHT_BRACE, this.ch);
                    this.nextChar();
                    break;
                }
                case "[":
                {
                    _loc_1 = JSONToken.create(JSONTokenType.LEFT_BRACKET, this.ch);
                    this.nextChar();
                    break;
                }
                case "]":
                {
                    _loc_1 = JSONToken.create(JSONTokenType.RIGHT_BRACKET, this.ch);
                    this.nextChar();
                    break;
                }
                case ",":
                {
                    _loc_1 = JSONToken.create(JSONTokenType.COMMA, this.ch);
                    this.nextChar();
                    break;
                }
                case ":":
                {
                    _loc_1 = JSONToken.create(JSONTokenType.COLON, this.ch);
                    this.nextChar();
                    break;
                }
                case "t":
                {
                    ...
                    if (_loc_2 == "true")
                    {
                        _loc_1 = JSONToken.create(JSONTokenType.TRUE, true);
                        this.nextChar();
                    }
                    else
                    {
                ...
                case "f":
                {
                    ...
                    if (_loc_3 == "false")
                    {
                        _loc_1 = JSONToken.create(JSONTokenType.FALSE, false);
                        this.nextChar();
                    }
                    else
                    {
                ...
                case "n":
                {
                    ...
                    if (_loc_4 == "null")
                    {
                        _loc_1 = JSONToken.create(JSONTokenType.NULL, null);
                        this.nextChar();
                    }
                    else
                    {
                ...
                case "N":
                {
                    ...
                    if (_loc_5 == "NaN")
                    {
                        _loc_1 = JSONToken.create(JSONTokenType.NAN, NaN);
                        this.nextChar();
                    }
                    else
                    {
        ...
        final private function readString() : JSONToken
        {
            ...
            var _loc_2:* = JSONToken.create(JSONTokenType.STRING, this.unescapeString(this.jsonString.substr(this.loc, _loc_1 - this.loc)));
            this.loc = _loc_1 + 1;
            this.nextChar();
            return _loc_2;
        }// end function
                ...
                if (_loc_3 >= 0)
                {
                    ...
                    switch(_loc_6)
                    {
                        ...
                        case "u":
                        {
                            ...
                            _loc_2 = _loc_2 + String.fromCharCode(parseInt(_loc_7, 16));
                            _loc_4 = _loc_8;
                            break;
                        }
                        case "f":
        ...
        final private function readNumber() : JSONToken
        {
            ...
            {
                return JSONToken.create(JSONTokenType.NUMBER, _loc_2);
            }
